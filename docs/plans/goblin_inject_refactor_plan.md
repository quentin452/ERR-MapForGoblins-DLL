...
permanent stay-behind (4d). **PR 4a DONE (branch `feat/inject-world-position`)** — world-
position/grace-data domain extracted to `src/goblin_world_position.cpp`, builds clean, deployed +
md5-verified, **NOT yet in-game log-checked** (game wasn't running at deploy time). PRs 4b/4c not
started. Modeled
