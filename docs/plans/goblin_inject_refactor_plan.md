...
**Status:** PR 0-3 DONE + IN-GAME CONFIRMED + MERGED to `master`. PR 4 scoped into 4a/4b/4c + a
permanent stay-behind (4d). **PR 4a DONE + IN-GAME CONFIRMED + MERGED** (`feat/inject-world-position`)
— world-position/grace-data domain extracted to `src/goblin_world_position.cpp`. PRs 4b/4c not
started. Modeled
