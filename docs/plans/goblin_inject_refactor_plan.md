...
**Status:** PR 0-3 + PR 4a DONE + IN-GAME CONFIRMED + MERGED to `master`. **PR 4b DONE + IN-GAME CONFIRMED + MERGED** (`feat/inject-tutorial-popup`)
— TutorialParam row injection + `world_map_open()` extracted to `src/goblin_tutorial_popup.cpp`.
PR 4c not started. Modeled
