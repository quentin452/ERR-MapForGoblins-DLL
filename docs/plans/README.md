...
| [goblin_inject_refactor_plan.md](goblin_inject_refactor_plan.md) — extract subsystems (icon-harvest, item classification, visibility+clustering) out of `goblin_inject.cpp`, the biggest hand-written god file | PR 0+1 DONE+MERGED; PR 2 (item classify) DONE `feat/inject-item-classify`, deployed, NOT yet in-game log-checked; PRs 3-4 not started |
