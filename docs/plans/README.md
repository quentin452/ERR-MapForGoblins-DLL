...
| [merchant_item_search_plan.md](merchant_item_search_plan.md) — make merchant/shop stock (incl. Twin Maidens bell-bearing goods) searchable in F1 | scoped 2026-07-02; Slice 1 (info-only shop-search rows) starting on `feat/merchant-search` |
