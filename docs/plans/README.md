...
| [goblin_inject_refactor_plan.md](goblin_inject_refactor_plan.md) — extract subsystems (icon-harvest, item classification, visibility+clustering) out of `goblin_inject.cpp`, the biggest hand-written god file | PR 0+1+2 DONE+MERGED; PR 3 (visibility+clustering) DONE `feat/inject-section-visibility`, deployed, NOT yet in-game log-checked; PR 4 not started |
