...
| [goblin_inject_refactor_plan.md](goblin_inject_refactor_plan.md) — extract subsystems (icon-harvest, item classification, visibility+clustering) out of `goblin_inject.cpp`, the biggest hand-written god file | PR 0 DONE+MERGED; PR 1 (icon-harvest) DONE `feat/inject-icon-harvest`, deployed, NOT yet in-game log-checked; PRs 2-4 not started |
