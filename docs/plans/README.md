...
| [goblin_inject_refactor_plan.md](goblin_inject_refactor_plan.md) — extract subsystems (icon-harvest, item classification, visibility+clustering) out of `goblin_inject.cpp`, the biggest hand-written god file | PR 0-3+4a+4b DONE+MERGED; PR 4c (grace suppression, LAST extraction PR) DONE `feat/inject-grace-suppression`, deployed, NOT yet in-game log-checked |
