...
| [goblin_inject_refactor_plan.md](goblin_inject_refactor_plan.md) — extract subsystems (icon-harvest, item classification, visibility+clustering) out of `goblin_inject.cpp`, the biggest hand-written god file | PR 0-3+4a DONE+MERGED; PR 4b (TutorialParam/world_map_open) DONE `feat/inject-tutorial-popup`, deployed, NOT yet in-game log-checked; PR 4c not started |
