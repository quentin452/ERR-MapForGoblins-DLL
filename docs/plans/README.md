...
| [clang_only_toolchain_plan.md](clang_only_toolchain_plan.md) — retire MSVC/msbuild, clang-cl+lld+ninja as the only toolchain (SEH audit Phase 0 blocking: 3 live `__try`-elision hazards found) | scoped 2026-07-01, not started; reverses same-day "MSVC canonical" memory note |
