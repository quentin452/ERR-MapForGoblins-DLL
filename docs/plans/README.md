...
| [category_descriptor_plan.md](category_descriptor_plan.md) — single data descriptor for a marker category (kills the ~6 scattered switches); Tier 2 = runtime live-add | scoped 2026-07-02, not started (near-term win from the scripting-API ROI note) |
