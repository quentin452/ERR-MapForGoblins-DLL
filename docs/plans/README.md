...
| [goblin_inject_refactor_plan.md](goblin_inject_refactor_plan.md) — extract subsystems (icon-harvest, item classification, visibility+clustering) out of `goblin_inject.cpp`, the biggest hand-written god file | scoped, not started; PR 0 (`LotReader` shared extraction) is the hard prerequisite for PRs 1-2 |
