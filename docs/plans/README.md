...
| [goblin_inject_refactor_plan.md](goblin_inject_refactor_plan.md) — extract subsystems (icon-harvest, item classification, visibility+clustering) out of `goblin_inject.cpp`, the biggest hand-written god file | PR 0-3 DONE+MERGED; PR 4a (world-position) DONE `feat/inject-world-position`, deployed, NOT yet in-game log-checked; PRs 4b/4c not started |
