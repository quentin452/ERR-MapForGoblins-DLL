...
- **Source**: runtime `[COVERAGE]` log (ERR profile), build 2026-06-26 00:44:10.544
...
|---|--:|--:|--:|--:|--:|
| **all categories** | **118** | 7883 | 469 | 188 | 8470 |

🔴 baked-only: **1**  ·  🟡 partial: **20**  ·  🟢 off-bake: **40**  (of 61 active categories)
...
| Loot - Crafting Materials | 1 | 1697 | 0 | 99 | 1698 | atlas 69% | 🟡 partial |
...
| World - Interactables | 23 | 79 | 0 | 0 | 102 | atlas 74% | 🟡 partial |
...
Residual loot total **80** = unknown 29 · treasure 16 (accepted) · enemy 35 (bake mis-label) · emevd 0 (recoverable).
...
| Loot - Crafting Materials | 0 | 1 | 0 | 0 |
