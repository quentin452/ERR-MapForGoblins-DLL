...
- **Source**: runtime `[COVERAGE]` log (ERR profile), build 2026-06-25 15:21:53.439
...
# **1036**  ← drive this to **0**

| | baked | disk | live | live-cls | total |
|---|--:|--:|--:|--:|--:|
| **all categories** | **1036** | 7338 | 463 | 186 | 8837 |

🔴 baked-only: **8**  ·  🟡 partial: **32**  ·  🟢 off-bake: **23**  (of 63 active categories)
