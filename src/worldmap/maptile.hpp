...
GOBLIN_RENDER_API bool parse_bhf4(const std::vector<uint8_t> &bhd, std::vector<Entry> &out);
...
GOBLIN_RENDER_API bool grid_range(const std::vector<Entry> &entries, const std::string &prefix, GridRange &out);
...
GOBLIN_RENDER_API bool load_archive(const std::string &rel_base, std::vector<Entry> &entries, std::vector<uint8_t> &bdt);
...
GOBLIN_RENDER_API std::vector<uint8_t> extract_dds(const std::vector<uint8_t> &bdt, const Entry &e, std::string &texName,
...
GOBLIN_RENDER_API std::vector<uint8_t> extract_named(const std::string &rel_base, const std::string &needle,
...
GOBLIN_RENDER_API std::string probe(const std::string &rel_base, int max_probe = 8, const char *name_filter = nullptr);
} // namespace goblin::worldmap::maptile
