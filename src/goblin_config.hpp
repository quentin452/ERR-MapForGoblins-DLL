...
namespace goblin
{
    ...
    namespace config
    {
        ...
        // teamType (24/27 = hostile) + resolver tier (3 = field-boss, else mob).
        ...
        extern GOBLIN_RENDER_API bool diagBootIo;       // [BOOTIO]: hook CreateFileW EARLY, log every file open during boot
        ...
        extern GOBLIN_RENDER_API bool debugMarkerTooltip; // marker provenance appended to map tooltips
