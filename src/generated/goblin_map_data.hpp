...
{
// Category enumerators are data-driven — the list lives in data/categories.json and is
// generated into goblin_categories_enum.gen.inc (tools/generate_categories.py). Enum
// VALUE == table index, so order is preserved. Add a category in categories.json, regen.
#include "goblin_categories_enum.gen.inc"
};
